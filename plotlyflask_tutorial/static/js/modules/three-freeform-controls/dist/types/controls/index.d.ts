...
import { DEFAULT_HANDLE_GROUP_NAME, IHandle } from "./handles";
...
export default class Controls extends Group {
     ...
     * @param options
     */
    constructor(object: Object3D, camera: Camera, options?: IControlsOptions);
     ...
     * @param limit
     */
    setTranslationLimit: (limit: TranslationLimit | false) => void;
    /**
     * @hidden
     */
     ...
     * @param visibility
     */
    showByNames: (handleNames: Array<DEFAULT_HANDLE_GROUP_NAME | string>, visibility?: boolean) => void;
    /**
